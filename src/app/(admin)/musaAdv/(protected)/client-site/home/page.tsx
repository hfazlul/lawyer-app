...
export default async function AdminHomePage() {
  const [slides, intro, stats, activities, testimonials] = await Promise.all([
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Hero slides, welcome, stats, activities, and testimonials. Service cards are managed in Services CMS.
          </p>
        </div>
